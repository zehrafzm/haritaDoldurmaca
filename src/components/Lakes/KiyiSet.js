  ...
  const handleTouch = (element) => {
    ...
    return (
      ...
      <Draggable
              key={999999}
              x={.14* windowWidth}
              y={.07* containerHeight}
              minX={.14* windowWidth}
              maxX={.14* windowWidth}
              minY={.07* containerHeight}  
              maxY={.07* containerHeight}               
            >
            {/**
             ...
             */}
              ...
              >
                <Text style={{padding:2, color:"whitesmoke",fontSize:aspectRatio*10}} >Terkos</Text>
              </View>
            </Draggable>
      {/**
