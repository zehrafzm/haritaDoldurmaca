  ...
  const handleTouch = (element) => {
    ...
    return (
      ...
      <Draggable
              key={999999}
              x={.3* windowWidth}
              y={.74* containerHeight}
              minX={.3* windowWidth}
              maxX={.3* windowWidth}
              minY={.74* containerHeight}  
              maxY={.74* containerHeight}           
            >
            {/**
             ...
             */}
              ...
              >
                <Text style={{padding:2, color:"whitesmoke",fontSize:aspectRatio*10}} >Avlan</Text>
              </View>
            </Draggable>
      {/**
