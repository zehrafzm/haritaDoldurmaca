    ...
    return (
      ...
      <View style={[styles.chronometer1, { top: containerHeight*.75, left:windowWidth*.67}]}>
            ...
            <Text style={styles.buttonText}>hepsini ekle</Text></Pressable>   
                ...
                placeholder=" Alüvyon Set Gölleri"
                value={mount}
      ...
      <Draggable
              key={999999}
              x={.34* windowWidth}
              y={.31* containerHeight}
              minX={.34* windowWidth}
              maxX={.34* windowWidth}
              minY={.31* containerHeight}  
              maxY={.31* containerHeight}            
            >
            {/**
             ...
             */}
              ...
              >
                <Text style={{padding:2, color:"whitesmoke",fontSize:aspectRatio*10}} >Eymir</Text>
              </View>
            </Draggable>
      {/**
