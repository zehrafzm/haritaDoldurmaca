  ...
  const handleTouch = (element) => {
    ...
    return (
      ...
      <Draggable
              key={999999}
              x={.48* windowWidth}
              y={.41* containerHeight}
              minX={.48* windowWidth}
              maxX={.48* windowWidth}
              minY={.41* containerHeight}  
              maxY={.41* containerHeight}             
            >
            {/**
             ...
             */}
              ...
              >
                <Text style={{padding:2, color:"whitesmoke",fontSize:aspectRatio*10}} >Kayseri</Text>
              </View>
            </Draggable>
      {/**
