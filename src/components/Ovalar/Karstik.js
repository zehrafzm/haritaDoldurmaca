  ...
  const handleTouch = (element) => {
    ...
    return (
      ...
      <Draggable
              key={999999}
              x={.32* windowWidth}
              y={.67* containerHeight}
              minX={.32* windowWidth}
              maxX={.32* windowWidth}
              minY={.67* containerHeight}  
              maxY={.67* containerHeight}           
            >
            {/**
             ...
             */}
              ...
              >
                <Text style={{padding:2, color:"whitesmoke",fontSize:aspectRatio*10}} >Korkuteli</Text>
              </View>
            </Draggable>
      {/**
